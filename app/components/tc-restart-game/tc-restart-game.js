...
var tcRestartGame = (function () {
    ...
    tcRestartGame.prototype.restartGame = function () {
        ...
        for (var index = 0; index < battleField.length; index++)
            battleField[index].innerHTML = '';
    };
    tcRestartGame = __decorate([
        core_1.Directive({
    ...
    return tcRestartGame;
}());
exports.tcRestartGame = tcRestartGame;
//# sourceMappingURL=tc-restart-game.js.map